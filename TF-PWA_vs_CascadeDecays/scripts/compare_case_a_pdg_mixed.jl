"""
Case (a): PDG Parent Masses + Mixed Lineshapes
...
function main()
    ...
    output_path === nothing && (output_path = joinpath(suite_dir, "amp_data", charge_tag, "case_a_cd_amp.txt"))
    ...
    println("Case (a): PDG Parent Masses + Mixed Lineshapes")
